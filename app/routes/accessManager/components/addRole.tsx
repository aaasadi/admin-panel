      ...
      <Card>
        <CardHeader className="flex flex-row justify-between items-start">
          <div>
            ...
            <CardDescription>Add new role with specific permissions</CardDescription>
          </div>
          <Button variant="ghost" size="icon" onClick={() => navigate("/access/rolemanager")}>
            <X className="h-5 w-5" />
          </Button>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4">
              <Button type="button" variant="outline" onClick={() => navigate("/access/rolemanager")}>
                Cancel
              </Button>
